//IPS ZUM ÄNDERN in Zeile 20, 21, 251
...
void displayTestActive(){
  displayTestVar = true;
  lcd.clear();
  lcd.setRGB(255, 231, 16);
  lcd.setCursor(0, 0);
  lcd.print("LCD Display Test");
  lcd.setCursor(0, 1);
  lcd.print("Status: Active");
}
void displayTestPassive(){
  if (displayTestVar == true){
    lcd.clear();
    lcd.setRGB(255, 231, 16);
    lcd.setCursor(0, 0);
    lcd.print("LCD Display Test");
